...
XTTS_LANG_MAP = {
    ...
    "Hungarian": "hu",
    "Korean": "ko",
    "Telugu": "hi",     # Phonetic Indian language proxy for XTTS v2
    "Tamil": "hi",
    "Kannada": "hi",
    "Malayalam": "hi",
    "Bengali": "hi",
...
# Cached global XTTS model instance to avoid re-loading on each request
_XTTS_MODEL = None
    ...
    try:
        ...
        if preprocess_audio_pipeline is not None:
            try:
                ...
                # Re-raise explicit multi-speaker rejection error
        ...
        # Cleanup temporary downloaded file if created
...
def synthesize_speech(
    ...
    # Step 1: Try XTTS v2 Voice Cloning if reference audio is provided and preserve_voice is True
    ...
    # Step 3: Enhance and convert output to 24kHz 256kbps stereo MP3
